...
>(({ className, ...props }, ref) => (
    <div className='scrollbar-custom relative w-full overflow-auto'>
        <table
            ref={ref}
...
>(({ className, ...props }, ref) => (
    <th
        ref={ref}
        className={cn(
            'h-12 px-4 text-left align-middle font-medium text-lynch-400 dark:text-neutral-400 [&:has([role=checkbox])]:pr-0',
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <td
        ref={ref}
        className={cn(
            'p-4 align-middle text-sm font-normal text-lynch-950 [&:has([role=checkbox])]:pr-0',
            className
        )}
        {...props}
    />
