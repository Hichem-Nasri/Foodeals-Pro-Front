...
const PaymentAndDelivery: FC<PaymentAndDeliveryProps> = ({
    ...
    //     { key: '1', label: 'Carte bancaire', icon: CreditCard },
    //     { key: '2', label: 'Espèce', icon: Wallet },
    // ]
    ...
    //         label: 'Foodeals',
    //         icon: FoodealsIcon,
    //         avatar: '/images/symbole-foodeals.svg',
    //     },
    // ]
    return (
        <div className='flex w-full flex-col items-center justify-evenly gap-4 rounded-[30px] bg-white p-4 pt-[25px] text-lynch-500'>
